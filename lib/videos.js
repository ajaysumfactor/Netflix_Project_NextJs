...
export const getVideos = async() => {
    ...
    // https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=25&q=disney%20trailer&topicId=%20%09&type=video&videoType=any&key=${YOUTUBE_API_KEY}
     ...
     const response=await fetch(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=25&q=disney%20trailer&topicId=%20%09&type=video&videoType=any&key=${YOUTUBE_API_KEY}`);
